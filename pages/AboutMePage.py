...
class AboutMePage:
    ...
    def open(self):
        self.driver.get("https://psycholog-vam.ru/SpecialistProfile.html")
    ...
    def checking_element_menu_education(self):
        element_education = WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(self.education))
